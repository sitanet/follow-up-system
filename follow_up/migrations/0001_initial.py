    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.PositiveBigIntegerField(blank=True, choices=[(1, 'Male'), (2, 'Female')], null=True)),
                ('marital_status', models.PositiveBigIntegerField(blank=True, choices=[(1, 'Single'), (2, 'Married')], null=True)),
                ...
                ('wedding_ann', models.CharField(blank=True, max_length=20, null=True)),
